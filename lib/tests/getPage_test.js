...
paginator.data = get_countup_countdown_1.getCountup(1, 50); // now data has numbers 1 thru 50.
...
if (arraysMatch_1.arraysMatch(page1, get_countup_countdown_1.getCountup(1, 25)) &&
    arraysMatch_1.arraysMatch(page2, get_countup_countdown_1.getCountup(26, 50)))
...
if (arraysMatch_1.arraysMatch(page1, get_countup_countdown_1.getCountup(1, 10)) &&
    arraysMatch_1.arraysMatch(page2, get_countup_countdown_1.getCountup(11, 20)) &&
    arraysMatch_1.arraysMatch(page3, get_countup_countdown_1.getCountup(21, 30)) &&
    arraysMatch_1.arraysMatch(page4, get_countup_countdown_1.getCountup(31, 40)) &&
    arraysMatch_1.arraysMatch(page5, get_countup_countdown_1.getCountup(41, 50)))
